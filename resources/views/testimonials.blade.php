    ...
    <section class="py-20 bg-white">
        <div class="container mx-auto px-4">
            <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
                ...
                <div class="group p-8 rounded-2xl bg-white border border-slate-100 shadow-sm hover:shadow-xl hover:-translate-y-2 transition-all duration-300"
                    ...
                    <blockquote class="text-slate-700 italic leading-relaxed mb-8">
                        "Excellent service! The team was punctual, professional and handled our furniture with great
                        care. Best decision we made for our move."
                    </blockquote>
                    <div class="flex items-center gap-4">
                        <img src="https://i.pravatar.cc/150?u=rajesh" alt="Rajesh Kumar"
                            class="w-12 h-12 rounded-full border-2 border-primary/20">
                        <div>
                            <p class="font-bold text-slate-900 text-sm">Rajesh Kumar</p>
                            <p class="text-xs text-slate-500 font-medium tracking-wide uppercase">Mumbai → Delhi</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="group p-8 rounded-2xl bg-white border border-slate-100 shadow-sm hover:shadow-xl hover:-translate-y-2 transition-all duration-300"
                    ...
                    <blockquote class="text-slate-700 italic leading-relaxed mb-8">
                        "Very smooth experience. The packing quality was outstanding and everything arrived in perfect
                    ...
                    <div class="flex items-center gap-4">
                        <img src="https://i.pravatar.cc/150?u=priya" alt="Priya Sharma"
                            class="w-12 h-12 rounded-full border-2 border-primary/20">
                        <div>
                            <p class="font-bold text-slate-900 text-sm">Priya Sharma</p>
                            <p class="text-xs text-slate-500 font-medium tracking-wide uppercase">Bangalore → Hyderabad
                            </p>
                        </div>
                    </div>
                </div>
                ...
                <div class="group p-8 rounded-2xl bg-white border border-slate-100 shadow-sm hover:shadow-xl hover:-translate-y-2 transition-all duration-300"
                    ...
                    <div class="flex items-center gap-1 mb-4">
                        ...
                        <svg class="w-5 h-5 text-slate-200 fill-current" viewBox="0 0 20 20">
                            <path
                                d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z" />
                        </svg>
                    </div>
                    <blockquote class="text-slate-700 italic leading-relaxed mb-8">
                        "Good service overall. The movers were experienced and efficient. Pricing was transparent and no
                        hidden costs were added."
                    </blockquote>
                    <div class="flex items-center gap-4">
                        <img src="https://i.pravatar.cc/150?u=amit" alt="Amit Patel"
                            class="w-12 h-12 rounded-full border-2 border-primary/20">
                        <div>
                            <p class="font-bold text-slate-900 text-sm">Amit Patel</p>
                            <p class="text-xs text-slate-500 font-medium tracking-wide uppercase">Pune → Chennai</p>
                        </div>
                    </div>
                </div>
